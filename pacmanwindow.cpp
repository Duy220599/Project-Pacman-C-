...
void PacmanWindow :: Mode_1_Joueur()
{
    ...
    msg.setText(" Vous etes passe en mode 1 joueur ");
...
void PacmanWindow :: Mode_2_Joueur()
{
    ...
    msg.setText(" Vous etes passe en mode 2 joueur ");
...
//// Button Continuer pour changer le mode
void PacmanWindow:: Button_Continuer()
{
    jeu.niveau2();
}

// handle perdu messenger
